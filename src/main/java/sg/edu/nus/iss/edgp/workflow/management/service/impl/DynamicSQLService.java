...
public class DynamicSQLService implements IDynamicSQLService {
	...
	public void buildCreateTableSQL(Map<String, Object> data, String tableName) {
		...
		try {
			...
			logger.info("successfull creating clean data table");

		} catch (Exception e) {
			logger.error("An error occurred while creating clean data table.... {}", e);
	...
	public void insertData(String tableName, Map<String, Object> data) {
		try {
			...
			logger.error("An error occurred while inserting clean data into the database.... {}", e);
